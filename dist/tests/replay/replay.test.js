...
const replay_verification_1 = require("../../runtime/replay/replay_verification");
const invariant_runner_1 = require("../../runtime/replay/invariant_runner");
const replay_invariants_1 = require("../../runtime/replay/replay_invariants");
...
async function runTests() {
    ...
    try {
        ...
        invariantRunner.registerInvariant(replay_invariants_1.ReplayInvariants.artifactHashInvariant);
        const state = {
    ...
    try {
        ...
        const eventStream = new replay_event_stream_1.ReplayEventStream([event]);
        const verification = new replay_verification_1.ReplayVerification();
