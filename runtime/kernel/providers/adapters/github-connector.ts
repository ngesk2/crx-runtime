 ...
 * 
 * Constitutional Runtime - Provider Adapter
...
import { AbstractConnector } from '../abstractions/abstract-connector';
import type { Readable, Queryable, Discoverable, Webhookable, ReadOptions, QueryOptions, StreamCallback, Unsubscribe, WebhookEvent, Schema, ResourceSchema, FieldSchema, StreamEvent, ConnectorConfig, HealthStatus, ConnectorMetrics } from '../../../contracts/src/providers';
