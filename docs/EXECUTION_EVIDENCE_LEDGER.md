...
**Commit**: <PENDING> "docs(evidence): canonicalization/ingestion boundary falsification - single service + single spine writer, two-front-door documented asymmetry (ledger 49)" - 1 file, ~15 insertions.
